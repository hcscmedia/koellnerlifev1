        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    <h4>Kontakt</h4>
                    <p>
                        <a href="mailto:<?php echo CONTACT_EMAIL; ?>" class="footer-email">
                            <?php echo CONTACT_EMAIL; ?>
                        </a>
                    </p>
                    <div class="social-links">
                        <?php if (SOCIAL_GITHUB): ?>
                            <a href="<?php echo SOCIAL_GITHUB; ?>" target="_blank" rel="noopener" class="social-link" aria-label="GitHub">
                        ...
                        <?php if (SOCIAL_TWITTER): ?>
                            <a href="<?php echo SOCIAL_TWITTER; ?>" target="_blank" rel="noopener" class="social-link" aria-label="Twitter">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="footer-bottom">
                ...
                <p class="footer-credits">Entwickelt mit ❤️ und modernster Technologie</p>
            </div>
        </div>
    </footer>
